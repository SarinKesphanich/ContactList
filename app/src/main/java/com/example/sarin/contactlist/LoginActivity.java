...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            String url = "http://contact.sarin.me/api/index.php/authen/login";
//            String url = "http://drgtretyertfhjyuj.com";
            RequestParams params_login = new RequestParams();
            params_login.put("email", email);
            params_login.put("pass", sha1(password));
            login(url, params_login);
        }
    }
     ...
     * @param params
     */
    public void login(String url, RequestParams params){
    ...
    private void nevigateToHome() {
        Intent groupContact = new Intent(this, GroupContact.class);
        startActivity(groupContact);
    }

    private void nevigateToRegis() {
        Intent data = new Intent(this, RegisterActivity.class);
        data.putExtra("email", gEmail);
        data.putExtra("pass", gPass);
        startActivity(data);
    }
